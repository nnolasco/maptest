/*
 *******************************************************************************
 *  Filename:   ./src/screens/JoinWaitlistScreen.tsx
 *  Syntax:     NA
 *  Synopsis:   Join Waitlist Screen.
 *  Notes:
 *      
 *  Revisions:
...
export class JoinWaitlistScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    joinList() {
        ...
        navigate("JoinWaitlistConfirmScreen");
    }
                ...
                <ImageBackground source={images.graphics["onboardbg"]} style={{flex: 1, resizeMode: 'cover', justifyContent: 'center'}}>
                    <View style={tailwind('pge-tw-flex-container-1 pge-tw-flex-col pge-tw-content-between pge-tw-m-6 pge-tw-p-6 pge-tw-rounded-xl pge-tw-bg-white')}>
                        ...
                        <View style={tailwind('pge-tw-flex-container-1 pge-tw-mt-8')}>
                            <StyledButton appearance="primary" size="full-width" label={buttons["submit"]} onPress={this.joinList} />
                            <StyledButton appearance="text" size="text" label={buttons["cancel"]} onPress={this.goHome} />
                        </View>
                    </View>
                </ImageBackground>
            </SafeAreaView>
...
export default connect(mapStateToProps, mapDispatchToProps)(JoinWaitlistScreen);